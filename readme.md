...
## Доп. вопросы от нашего семера

### Типы рисков

- Финансовый риск: Связан с потерей из-за изменений рыночных цен, таких как цены акций, облигаций, валют и товаров.
- Операционный риск: Связан с возможными сбоями и неполадками в технологических системах.
- Стратегический риск: Связан с изменениями в потребительских предпочтениях, технологическом развитии или другими факторами, влияющими на рынок.
- Экологический риск: Возможность ущерба, вызванного природными явлениями, такими как землетрясения, наводнения или ураганы.

### Виды купонов

- **Фиксированный купон (Fixed Rate Coupon)**: Это самый распространенный тип купона. По фиксированному купону эмитент обязуется выплачивать владельцам облигации фиксированный процент от номинальной стоимости облигации в течение всего срока ее действия.
- **Переменный купон (Floating Rate Coupon)**: При переменном купоне процентная ставка меняется в соответствии с определенным финансовым показателем, как правило, базовой ставкой (например, LIBOR) плюс некоторый процентный надбавка. Это позволяет адаптировать купон к текущим рыночным условиям.
- **Нулевой купон (Zero Coupon)**: Нулевые облигации не выплачивают купоны в течение срока действия. Вместо этого они продаются с дисконтом по отношению к номиналу, и в конце срока владелец получает сумму, равную номиналу облигации.
- **Индексированный купон (Inflation-Linked Coupon)**: Такие облигации связаны с индексом инфляции. Купоны и номинальная стоимость могут регулироваться в соответствии с изменениями уровня инфляции.
  
### Кредитные рейтинги

**Стандарт & Пурз (S&P)**:
- AAA: Высший уровень надежности.
- AA: Очень высокий уровень надежности.
- A: Высокий уровень надежности.
- BBB: Уровень надежности средний.

### Что влияет на кредитные рейтинги
...
**Проспект ценных бумаг** — это документ, предоставляемый эмитентом (компанией, государством или другой организацией) при размещении ценных бумаг на рынке. Этот документ содержит информацию о компании, ее финансовом положении, бизнес-модели, рисках, правилах размещения ценных бумаг, а также другие существенные данные, которые могут быть полезными потенциальным инвесторам.
